...
/*
 * Create a program capable of asking the user for new friend data (name, age,
 * e-mail, comments), show all existing ones (name only) or search (in name,
 * e-mail, and comments, regardless of capital letters, and showing all data).
 * Each time a friend is added, their data will be saved in a file, using
 * serialization. Each time the program is re-entered, existing data will be
 * loaded.
 *
 * The menu will show the options:
 *
 * 1. Add a person.
 * 
 * 2. See everyone's names.
 *
 * 3. Search
 * 
 * 0. Exit
